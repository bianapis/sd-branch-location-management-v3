...
/**
 * BQCustomerLiaisonCaptureOutputModel
 */
public class BQCustomerLiaisonCaptureOutputModel   {
  private String customerLiaisonCaptureActionTaskReference = null;

  private Object customerLiaisonCaptureActionTaskRecord = null;

  private String customerLiaisonCaptureRecordReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Customer Liaison instance capture service call 
   * @return customerLiaisonCaptureActionTaskReference
  **/

  public String getCustomerLiaisonCaptureActionTaskReference() {
    return customerLiaisonCaptureActionTaskReference;
  }

  public void setCustomerLiaisonCaptureActionTaskReference(String customerLiaisonCaptureActionTaskReference) {
    this.customerLiaisonCaptureActionTaskReference = customerLiaisonCaptureActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The capture service call consolidated processing record 
   * @return customerLiaisonCaptureActionTaskRecord
  **/

  public Object getCustomerLiaisonCaptureActionTaskRecord() {
    return customerLiaisonCaptureActionTaskRecord;
  }

  public void setCustomerLiaisonCaptureActionTaskRecord(Object customerLiaisonCaptureActionTaskRecord) {
    this.customerLiaisonCaptureActionTaskRecord = customerLiaisonCaptureActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Customer Liaison structured input transaction/record 
   * @return customerLiaisonCaptureRecordReference
  **/

  public String getCustomerLiaisonCaptureRecordReference() {
    return customerLiaisonCaptureRecordReference;
  }

  public void setCustomerLiaisonCaptureRecordReference(String customerLiaisonCaptureRecordReference) {
    this.customerLiaisonCaptureRecordReference = customerLiaisonCaptureRecordReference;
  }

...
import org.bian.dto.BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceAnalysis;
import org.bian.dto.BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceReport;

import javax.validation.Valid;
  
/**
 * BQStaffandLocationPlanningRetrieveOutputModel
 */
public class BQStaffandLocationPlanningRetrieveOutputModel   {
  private String staffandLocationPlanningRetrieveActionTaskReference = null;

  private Object staffandLocationPlanningRetrieveActionTaskRecord = null;

  private String staffandLocationPlanningRetrieveActionResponse = null;

  private BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceReport staffandLocationPlanningInstanceReport = null;

  private BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceAnalysis staffandLocationPlanningInstanceAnalysis = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Staff and Location Planning instance retrieve service call 
   * @return staffandLocationPlanningRetrieveActionTaskReference
  **/

  public String getStaffandLocationPlanningRetrieveActionTaskReference() {
    return staffandLocationPlanningRetrieveActionTaskReference;
  }

  public void setStaffandLocationPlanningRetrieveActionTaskReference(String staffandLocationPlanningRetrieveActionTaskReference) {
    this.staffandLocationPlanningRetrieveActionTaskReference = staffandLocationPlanningRetrieveActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The retrieve service call consolidated processing record 
   * @return staffandLocationPlanningRetrieveActionTaskRecord
  **/

  public Object getStaffandLocationPlanningRetrieveActionTaskRecord() {
    return staffandLocationPlanningRetrieveActionTaskRecord;
  }

  public void setStaffandLocationPlanningRetrieveActionTaskRecord(Object staffandLocationPlanningRetrieveActionTaskRecord) {
    this.staffandLocationPlanningRetrieveActionTaskRecord = staffandLocationPlanningRetrieveActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of the retrieve action service response (lists returned reports) 
   * @return staffandLocationPlanningRetrieveActionResponse
  **/

  public String getStaffandLocationPlanningRetrieveActionResponse() {
    return staffandLocationPlanningRetrieveActionResponse;
  }

  public void setStaffandLocationPlanningRetrieveActionResponse(String staffandLocationPlanningRetrieveActionResponse) {
    this.staffandLocationPlanningRetrieveActionResponse = staffandLocationPlanningRetrieveActionResponse;
  }


  /**
   * Get staffandLocationPlanningInstanceReport
   * @return staffandLocationPlanningInstanceReport
  **/

  public BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceReport getStaffandLocationPlanningInstanceReport() {
    return staffandLocationPlanningInstanceReport;
  }

  public void setStaffandLocationPlanningInstanceReport(BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceReport staffandLocationPlanningInstanceReport) {
    this.staffandLocationPlanningInstanceReport = staffandLocationPlanningInstanceReport;
  }


  /**
   * Get staffandLocationPlanningInstanceAnalysis
   * @return staffandLocationPlanningInstanceAnalysis
  **/

  public BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceAnalysis getStaffandLocationPlanningInstanceAnalysis() {
    return staffandLocationPlanningInstanceAnalysis;
  }

  public void setStaffandLocationPlanningInstanceAnalysis(BQStaffandLocationPlanningRetrieveOutputModelStaffandLocationPlanningInstanceAnalysis staffandLocationPlanningInstanceAnalysis) {
    this.staffandLocationPlanningInstanceAnalysis = staffandLocationPlanningInstanceAnalysis;
  }
